...
pers.add_argument("-o","--output", help="Output File Name base", metavar="FOUT.DIM")
...
print("... "+node.source.source_path+ " loaded")
print("... "+string(node.source.num_frames)+" frames found")
# Handle warnings
...
# MODIFIERS
#----------------------------------------------------------
print("... CNA cutoff = "+string(args.cna))
...
if time is not None:
    ...
    fps = 10
dataset.anim.frames_per_second = fps

rs = RenderSettings(
    filename = args.output+".avi",
    size = (1024, 768),
    background_color=(0,0,0),
    custom_range = (args.range[0],args_range[1]),
    renderer = OpenGlRenderer,
    range = RenderSettings.Range.CUSTOM_INTERVAL
)
rs.renderer.antialiasing = True
node.source.cell.display.rendering_color = (1,1,1)
